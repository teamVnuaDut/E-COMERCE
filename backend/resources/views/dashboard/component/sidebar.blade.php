<aside class="w-64 bg-white h-screen shadow-md fixed top-0 left-0 flex flex-col">
    ...
    <nav class="flex-1 px-4 py-6">
        <ul class="space-y-2">
            <li>
                <a href="/dashboard" class="flex items-center px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 transition-colors">
            ...
            <li>
                <a href="/dashboard/products" class="flex items-center px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 transition-colors">
            ...
            <li>
                <a href="/dashboard/orders" class="flex items-center px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 transition-colors">
            ...
            <li>
                <a href="/dashboard/customers" class="flex items-center px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 transition-colors">
            ...
            <li>
                <a href="/dashboard/settings" class="flex items-center px-3 py-2 rounded-lg text-gray-700 hover:bg-blue-100 hover:text-blue-700 transition-colors">
